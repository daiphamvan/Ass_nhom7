<%@ Page Language="C#" AutoEventWireup="true" CodeFile="chitietsanpham.aspx.cs" Inherits="js_chitietsanpham" %>
	...
	<div class="header">
		...
		<div class="container">
			<div class="h_menu4">
				...
				<ul class="nav">
					<li ><a href="index.html"><i> </i>Desktops</a></li>
		...
		<div class="container">
			<div class="products">
					...
					<div class="clearfix">
                        ...
                        <asp:DetailsView ID="DetailsView1" runat="server" Height="99px" Width="159px" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="MaLoai" DataSourceID="SqlDataSource1">
                            <Fields>
					    ...
					    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Nhom7ConnectionString2 %>" DeleteCommand="DELETE FROM [LoaiSanPham] WHERE [MaLoai] = @MaLoai" InsertCommand="INSERT INTO [LoaiSanPham] ([MaLoai], [TenLoaiSp], [SanPham_MaSp]) VALUES (@MaLoai, @TenLoaiSp, @SanPham_MaSp)" SelectCommand="SELECT [MaLoai], [TenLoaiSp], [SanPham_MaSp] FROM [LoaiSanPham]" UpdateCommand="UPDATE [LoaiSanPham] SET [TenLoaiSp] = @TenLoaiSp, [SanPham_MaSp] = @SanPham_MaSp WHERE [MaLoai] = @MaLoai">
                            <DeleteParameters>
