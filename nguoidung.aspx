<%@ Page Language="C#" AutoEventWireup="true" CodeFile="nguoidung.aspx.cs" Inherits="nguoidung" %>
...
<body>
  ...
  <!--header-->
    ...
    <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="432px" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="MaNguoiDung" DataSourceID="SqlDataSource1">
        <Fields>
            <asp:BoundField DataField="MaNguoiDung" HeaderText="MaNguoiDung" ReadOnly="True" SortExpression="MaNguoiDung" />
            <asp:BoundField DataField="MatKhau" HeaderText="MatKhau" SortExpression="MatKhau" />
            <asp:BoundField DataField="TinhNang" HeaderText="TinhNang" SortExpression="TinhNang" />
		...
		<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Nhom7ConnectionString4 %>" DeleteCommand="DELETE FROM [NguoiDung] WHERE [MaNguoiDung] = @MaNguoiDung" InsertCommand="INSERT INTO [NguoiDung] ([MaNguoiDung], [MatKhau], [TinhNang], [HoVaTen], [DiaChi], [GioiTinh]) VALUES (@MaNguoiDung, @MatKhau, @TinhNang, @HoVaTen, @DiaChi, @GioiTinh)" SelectCommand="SELECT [MaNguoiDung], [MatKhau], [TinhNang], [HoVaTen], [DiaChi], [GioiTinh] FROM [NguoiDung]" UpdateCommand="UPDATE [NguoiDung] SET [MatKhau] = @MatKhau, [TinhNang] = @TinhNang, [HoVaTen] = @HoVaTen, [DiaChi] = @DiaChi, [GioiTinh] = @GioiTinh WHERE [MaNguoiDung] = @MaNguoiDung">
            <DeleteParameters>
            ...
            <InsertParameters>
                ...
                <asp:Parameter Name="TinhNang" Type="Int32" />
